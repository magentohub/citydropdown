...
namespace Magentohub\CityDropdown\Plugin\Checkout;
...
class BillingAddressLayoutProcessor
{
    ...
    private function changeCity(string $paymentMethodForm): self
    {
        if(isset($this->result['components']['checkout']['children']['steps']['children']['billing-step']['children']
            ...
            $city['component'] = 'Magentohub_CityDropdown/js/form/element/city';
    ...
    {
        return [
            'component' => 'Magentohub_CityDropdown/js/form/element/city-select',
            'config' => [
